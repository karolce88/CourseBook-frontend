...
const recommended = document.querySelector(".recommended-carousel");
if (recommended) {
  const recommendedCarousel = new Splide(recommended, {
    type: "loop",
    // perPage: 2,
    fixedWidth: "440",
    gap: 36,
  ...
  recommendedCarousel.mount();
}

const offertNavigation = document.querySelector(".offert-nav");
if (offertNavigation) {
  const offertNav = new Splide(offertNavigation, {
    arrows: false,
    pagination: false,
    fixedWidth: "228",
    gap: 18,
...
const courseThumbs = document.querySelector(".courseThumbs");
const courseBig = document.querySelector(".courseBig");
if (courseThumbs && courseBig) {
  const main = new Splide(courseBig, {
    perPage: 1,
    easing: "ease",
    arrows: true,
    pagination: false,
  ...
  const thumbs = new Splide(courseThumbs, {
    rewind: true,
    isNavigation: true,
    autoHeight: true,
    direction: "ttb",
...
const relationsImages = document.querySelector(".relationsImages");
if (relationsImages) {
  const slider = new Splide(relationsImages, {
    type: "loop",
    perPage: 3,
    gap: 20,
    arrows: true,
